...
//Defines do MQTT
#define ID_MQTT     "MQTTCarlos" //Modifique seu ID este ID, de o nome que quiser
...
const char* mqtt_server = "192.168.0.6"; //coloque aqui sua senha   
...
const int smart =  D6;       //Pino onde esta ligada a tomada ventilador
...
void verifica_e_envia_valor_potenciometro(void)
{
  ...
  TemporizacaoADC = millis();
   ...
   setpoint = map(setpoint, 0, 1024, 0, 60);
   float Temperatura;
